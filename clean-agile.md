...
利益相关者按照业务价值优先级给需求排序，我们只做利益相关者要求我们做的高优先级需求
...
- 验收测试由业务分析人员和 QA 在迭代中点之前编写。开发人员把这些测试集成进持续构建
...
管理者不要把每日站会当成监督大家工作的工具

---

### 小节

敏捷就是一组原则、实践和纪律，帮助小的团队构建小的软件项目
...
- 在有测试失败的情况下允许再写测试代码，编译失败也是失败的测试<!-- .element: class="fragment" -->
...
- 敏捷的技术实践是任何敏捷工作中最重要的组成部分
- 任何没有技术实践的敏捷实践尝试都注定要失败
...
- 沟通和行为的直接性<!-- .element: class="fragment" -->
...
作者认为是时候有人站出来告诉大家敏捷是什么了。是时候记住这些基础知识了。这些基础是 Circle of Life 。是极限编程的价值观、原则和纪律。是重构的动机、技术和纪律。这些基本原则是古老的、经过考验的、正确的，是敏捷软件开发的核心
